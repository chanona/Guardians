...
void CSkyBox::Move(ULONG nDirection, float fDistance, bool bVelocity)
{
}

void CSkyBox::Move(const D3DXVECTOR3 & d3dxvShift, bool bVelocity)
{
...
void CSkyBox::Rotate(float x, float y, float z)
{
}

void CSkyBox::Update(float fTimeElapsed)
{
...
void CSkyBox::RegenerateWorldMatrix()
{
...
void CSkyBox::OnMonsterUpdated(float fTimeElpased)
{
...
void CSkyBox::Render(ID3D11DeviceContext * pd3dDeviceContext)
{
	if (m_pShader)
	{
